                    ...
                    <div className="">
                        <div className="mx-[6%] my-[3%] sm:flex ">
                            ...
                            <div className=" self-center ">
                                <div className="  font-extrabold text-[200%] text-slate-300">Akhlad Kaifi</div>
                                <div className="text-white">Navigating through the website was a breeze, thanks to its organized layout. The diverse range of products left me spoilt for choice. Checkout was quick and hassle-free, with secure payment options. Delivery was prompt, and my items arrived in perfect condition.</div>
                            </div>
                        </div>
                    </div>
                    <div className="">
                        <div className="mx-[6%] my-[3%] sm:flex ">
                            <img className=' rounded-full mr-[2%]' src="https://source.unsplash.com/300x300/?profile" alt="" />
                            <div className=" self-center ">
                                <div className="  font-extrabold text-[200%] text-slate-300">Kirtan Jain</div>
                                <div className="text-white">Finding what I needed was effortless, thanks to the intuitive search function. The detailed product descriptions helped me make informed decisions. Customer service was responsive and helpful, addressing my queries promptly. Overall, a seamless shopping experience from start to finish.</div>
                            </div>
                        </div>
                    </div>
                    <div className="">
                        <div className="mx-[6%] my-[3%] sm:flex ">
                            <img className=' rounded-full mr-[2%]' src="https://source.unsplash.com/300x300/?profile" alt="" />
                            <div className=" self-center ">
                                <div className="  font-extrabold text-[200%] text-slate-300">Om Dorugade</div>
                                <div className="text-white">The website offers a wide variety of products to cater to every need. Competitive prices and regular discounts add value to the shopping experience. Convenient payment options, including cash on delivery, make transactions easy. Delivery was swift, with items arriving as expected.</div>
                            </div>
                        </div>
                    </div>
                    <div className="">
                        <div className="mx-[6%] my-[3%] sm:flex ">
                            <img className=' rounded-full mr-[2%]' src="https://source.unsplash.com/300x300/?profile" alt="" />
                            <div className=" self-center ">
                                <div className="  font-extrabold text-[200%] text-slate-300">Rahul Jagwan</div>
                                <div className="text-white">The website's modern design and sleek interface caught my eye immediately. Browsing through products was a delight, with clear categories and filters. The checkout process was straightforward, with secure payment methods. I appreciated the attention to detail in every aspect of the website.</div>
                            </div>
                        </div>
                    </div>
                    <div className="">
                        <div className="mx-[6%] my-[3%] sm:flex ">
                            <img className=' rounded-full mr-[2%]' src="https://source.unsplash.com/300x300/?profile" alt="" />
                            <div className=" self-center ">
                                <div className="  font-extrabold text-[200%] text-slate-300">Aditya Chaudhary</div>
                                <div className="text-white">This website has become my go-to for online shopping due to its reliability. The seamless ordering process and timely delivery inspire confidence. The customer support team is responsive and efficient, ensuring a positive experience. I highly recommend this platform to fellow shoppers.</div>
                            </div>
                        </div>
                    </div>
                </Carousel>
